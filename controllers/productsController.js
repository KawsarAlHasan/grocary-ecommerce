...
exports.createProducts = async (req, res) => {
  try {
    ...
    const [result] = await db.query(
      "INSERT INTO products (category_id, name, product_type, unit, long_description, short_description, packaging, uvw, in_stock, tax, country, purchase_price, regular_price, selling_price, whole_price, discount_price, supper_marcent) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",
      [
        category_id,
        name || null,
        product_type || null,
...
exports.productName = async (req, res) => {
  try {
    ...
    const [data] = await db.query(
      "SELECT id, name, purchase_price, regular_price, selling_price, whole_price, discount_price, supper_marcent, tax  FROM products WHERE status = 'active'"
    );
